...
この記事は、<ExternalLink href="https://beta.nextjs.org/docs">Next.js 13 Beta Docs</ExternalLink> の要点をまとめて日本語に翻訳したものです（一部、他ドキュメントの情報あり）。翻訳ツールの出力をそのまま使用しているので、不自然な表現があるかもしれません。どうぞご了承ください。
...
<ExternalLink href="https://beta.nextjs.org/docs/styling/tailwind-css">
